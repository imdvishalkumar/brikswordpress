				...
				<?php if(have_rows('benefits_repeater')): ?>
					<div class="columns">
						<?php while(have_rows('benefits_repeater')): the_row();
							$icon = wp_get_attachment_image_src(get_sub_field('benefit_icon'),'full')[0];
			...
			<div class="wrapper">
				...
				<div class="video">
					<?php   $videoid = get_field('video_id');
							$videoplaceholder = wp_get_attachment_image_src(get_field('video_image_placeholder'),'full')[0]; ?>
					<a href="#" class="placeholder colorbox video" data-video="<?php echo $videoid; ?>"><img src="<?php echo $videoplaceholder; ?>"/></a>
				</div>
			</div>
		</section>
			...
			<div class="wrapper">
				...
				<div id="masonry-container">
					<?php while(have_rows('success_repeater')): the_row();
							$background = wp_get_attachment_image_src(get_sub_field('success_background'),'full')[0];
						...
						?>
						<div class="box <?php echo $size; ?> img-fill" style="background-image:url(<?php echo $background; ?>);">
							<div class="content">
								<div class="valign">
