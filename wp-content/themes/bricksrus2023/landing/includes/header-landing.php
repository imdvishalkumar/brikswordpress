...
<html lang="en-US" class="no-js">
	...
	<head>
		...
		<title>
			<?php if(isset($seotitle) && !empty($seotitle)) { 
				echo $seotitle; 
			} else { 
				...
				<div class="wrapper">
					...
					<div class="logo">
						<a href="//bricksrus.com" target="_blank">
							<img itemprop="logo" src="https://www.bricksrus.com/wp-content/themes/bricksrus2023/landing/includes/img/logo.png" alt="Bricks R Us Logo" class="logo-img">
						</a>
					</div>
					<div class="phone">
